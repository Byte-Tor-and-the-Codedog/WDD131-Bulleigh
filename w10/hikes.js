...
const searcher = document.querySelector("#searchButton");
...
function filterHikes(hike, hikeQuery) {
...
function runASearch() {
    ...
    let hikeResults = hikes.filter(hike => filterHikes(hike, hikeQuery)).sort(compare);
    hikeResults.forEach(function(hike) {
        hikeContainer.innerHTML += `
        <div class="hike-card">
